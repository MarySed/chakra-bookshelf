// Note: Stolen from Tom Critchlow's very interesting article on a goodreads alternative https://tomcritchlow.com/2020/04/15/library-json/ in large part because it overlaps with my library quite a bit! Robin Hobb = yay
